...
public class Redbull extends BaseActivity
    ...
    @BindView(R.id.recyclerView_eventos_redbull)
    RecyclerView rv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getText(R.string.title_activity_redbull));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.opcion_todos:
                Intent intent1= new Intent(Redbull.this,Home.class);
                startActivity(intent1);
                finish();
                break;
            case R.id.opcion_menu_fms:
                Intent intent2= new Intent(Redbull.this,Fms.class);
            ...
            case R.id.opcion_menu_bdm:
                Intent intent4= new Intent(Redbull.this,Bdm.class);
                startActivity(intent4);
                finish();
                break;
            case R.id.opcion_supremaciamc:
                Intent intent5= new Intent(Redbull.this,Supremacia.class);
                startActivity(intent5);
                finish();
                break;
            case R.id.opcion_ivita_amigos:
                Intent intent6= new Intent(Redbull.this,Invita.class);
                startActivity(intent6);
                finish();
                break;
            case R.id.opcion_ajustes_cuenta:
                Intent intent7= new Intent(Redbull.this,Ajustes.class);
            ...
            case R.id.opcion_premios:
                Intent intent8= new Intent(Redbull.this,Premios.class);
    ...
    private void initializeRecyclerView() {
        LinearLayoutManager llm = new LinearLayoutManager(Redbull.this);
        rv.setLayoutManager(llm);
    }

    private void getEventos() {
        Redbull.MyAsyncTasks myAsyncTasks = new Redbull.MyAsyncTasks();
    ...
    public class MyAsyncTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Redbull.this);
        ...
        protected void onPostExecute(String s) {
            ...
            adapter = new RVAdapter(eventos, Redbull.this);
    ...
    private void irPerfil(){
        startActivity(Redbull.this,Ajustes.class);
        finish();
    }
}
