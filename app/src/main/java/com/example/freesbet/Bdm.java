...
public class Bdm extends BaseActivity
    ...
    @BindView(R.id.recyclerView_eventos_bdm)
    RecyclerView rv;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getText(R.string.title_activity_bdm));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.opcion_todos:
                Intent intent1= new Intent(Bdm.this,Home.class);
                startActivity(intent1);
                finish();
                break;
            case R.id.opcion_menu_fms:
                Intent intent2= new Intent(Bdm.this,Fms.class);
                startActivity(intent2);
                finish();
                break;
            case R.id.opcion_menu_redbull:
                Intent intent3= new Intent(Bdm.this, Redbull.class);
            ...
            case R.id.opcion_supremaciamc:
                Intent intent5= new Intent(Bdm.this,Supremacia.class);
                startActivity(intent5);
                finish();
                break;
            case R.id.opcion_ivita_amigos:
                Intent intent6= new Intent(Bdm.this,Invita.class);
                startActivity(intent6);
                finish();
                break;
            case R.id.opcion_ajustes_cuenta:
                Intent intent7= new Intent(Bdm.this,Ajustes.class);
            ...
            case R.id.opcion_premios:
                Intent intent8= new Intent(Bdm.this,Premios.class);
    ...
    private void initializeRecyclerView() {
        LinearLayoutManager llm = new LinearLayoutManager(Bdm.this);
        rv.setLayoutManager(llm);
    }

    private void getEventos() {
        Bdm.MyAsyncTasks myAsyncTasks = new Bdm.MyAsyncTasks();
    ...
    public class MyAsyncTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Bdm.this);
        ...
        protected void onPostExecute(String s) {
            ...
            adapter = new RVAdapter(eventos, Bdm.this);
